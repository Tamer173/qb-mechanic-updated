...
function GetVehicleData(vehicle)
	...
	local tempData = {
		...
		plate = QBCore.Functions.MathTrim(GetVehicleNumberPlateText(vehicle)),
		plateIndex= GetVehicleNumberPlateTextIndex(vehicle),

		bodyHealth= QBCore.Functions.MathRound(GetVehicleBodyHealth(vehicle), 1),
		engineHealth= QBCore.Functions.MathRound(GetVehicleEngineHealth(vehicle), 1),

		fuelLevel = QBCore.Functions.MathRound(GetVehicleFuelLevel(vehicle), 1),
		dirtLevel = QBCore.Functions.MathRound(GetVehicleDirtLevel(vehicle), 1),
