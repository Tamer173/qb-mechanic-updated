...
title = 'UPGRADES',
options = {
{label = 'Engine', img = 'img/icons/engine.png', modType = 11, priceMult = {10.0, 15.0, 25.0, 35.0, 45.0, 60.0}},
{label = 'Brakes', img = 'img/icons/brakes.png', modType = 12, priceMult = {9.0, 16.0, 22.0, 34.0, 55.0}},
{label = 'Transmission', img = 'img/icons/transmission.png', modType = 13, priceMult = {35.0, 40.0, 50.0, 60.0, 70.0}},
{label = 'Suspension', img = 'img/icons/suspension.png', modType = 15, priceMult = {1.0, 2.0, 3.0, 4.0, 55.0}},
{label = 'Armor', img = 'img/icons/armor.png', modType = 16, priceMult = {10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0}},
{label = 'Turbo', img = 'img/icons/engine.png', modType = 18, priceMult = {50.0, 100.0}},
},
